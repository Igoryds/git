...
Иногда при слиянии веток возникает сутуация когда информация в одном разделе в нескольких ветках отличается. в данном случае появляется следующее окно, в котором необходимо выбрать какой вариант оставить.
